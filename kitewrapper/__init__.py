...
class KiteFront(KiteConnect):
    ...
    _routes = {
        ...
        "orders.modify": "/orders/{order_id}",
        "orders.cancel": "/orders/{order_id}",
        ...
        "market.quote": "https://api.kite.trade/instruments/{exchange}/{tradingsymbol}",
    ...
    def _request(self, route, method, parameters=None):
        ...
        try:
            ...
            r = self.session.request(method,
                                     url,
                                     json=params if method in ["PUT", "POST"] else None,
        ...
        if "json" in r.headers["content-type"]:
            ...
            raise ex.DataException(
                "Unknown Content-Type (%s) in response: (%s)" % (r.headers["content-type"], r.content))
